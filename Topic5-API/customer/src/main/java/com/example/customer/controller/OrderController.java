...
public class OrderController {
    ...
    public ResponseEntity<List<OrderDTO>> getOrdersByEmployeeId(@PathVariable("employeeId") Integer id) {
        List<OrderDTO> orders = orderService.getOrdersByEmployeeId(id);
        return ResponseEntity.ok(orders);
    }
